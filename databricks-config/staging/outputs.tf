...
output "mlops-test_batch_inference_job_id" {
...
output "mlops-test_experiment_id" {
  value = databricks_mlflow_experiment.experiment.id
}

output "mlops-test_experiment_name" {
...
output "mlops-test_training_job_id" {
